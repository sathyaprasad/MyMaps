		...
		OnClickListener ocl = new OnClickListener() {
			...
			public void onClick(View v) {
				if (legendsControl == null
					...
					Log.i("appdash",
							"legend control child count: "
									+ Integer.toString(legendsControl
											.getChildCount()));
		...
		layerSwitch
				.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
							boolean isChecked) {
						if (activity.mapView.getLayer(index) instanceof GroupLayer) {
							Layer[] ls = ((GroupLayer) activity.mapView
									.getLayer(index)).getLayers();
							for (Layer l : ls) {
								l.setVisible(isChecked);
							}
						} else {
							activity.mapView.getLayer(index).setVisible(
									!activity.mapView.getLayer(index)
											.isVisible());
						}
